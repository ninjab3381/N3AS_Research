program sigma_v_calculation
    ! This program calculates sigma_v depending on given sigma or s_factor     
        ...
        ! Type declarations
          ...
          S_theory_coeff_E_p, S_theory_coeff_E, first_integral, second_integral, f_2
        ...
        !     end do
           ...
           open(7, file = 'squared_err_arr_values_Nature_with_rate.dat')

           open(8, file = 'rxn_rate_err_1')
           open(9, file = 'rxn_rate_err_2')
           open(10, file = 'rxn_rate_err_3')
           ...
           do i= 1, size(T9)
             ...
             sigma_v_int = 0
                ...
                do j = 1, size(GL_x_root)
                    ...
                    IF(E_root_keV <2.0) THEN
                     ...
                     ELSE IF (E_root_keV < 32.0 .or. E_root_keV> 262.9 ) THEN
                     ...
                     ELSE
                        call interp(size(S), E, S, E_root, S_root)
         
                        write(3, *) "interp", T9(i), E_root_keV, S_root
         
                     END IF


                    f_2 = S_root*EXP(-(((E_G*11.605)/(T9(i)*GL_x_root(j)))**(0.5))) 
                    sigma_v_int = sigma_v_int + GL_w_root(j)*f_2
             ...
             write(7,*) T9(i), sigma_v, squared_err_arr(i),  squared_err_arr(i)**(0.5)

             write(8, *) T9(i),  sigma_v

             write(9, *) T9(i),  sigma_v + squared_err_arr(i)**(0.5)
            
             if (sigma_v - squared_err_arr(i)**(0.5) < 0) then
               write(10, *) T9(i),  0.0
             else
               write(10, *) T9(i),  sigma_v - squared_err_arr(i)**(0.5)
             end if
