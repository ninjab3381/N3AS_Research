...
!      IF (xi(1).eq.0.) THEN !this is the 0 condition
!        f(1) = (1.000 + 0.565/z1 - 6.382/z2 + 11.108/z3
!    a            + 36.492/z4 + 27.512/z5)/tau
!        !f(1)  = thm(13)/tau  !Forward rate for weak np reaction.
!        r(1) = (5.252/z1 - 16.229/z2 + 18.059/z3 + 34.181/z4
!    a             + 27.617/z5)*ex(-2.531*z)/tau
...
C..........COMPARE LIMITS AND TAKE LARGER OF THE TWO.
	 ...
	 IF (tph == 0.00001) THEN
		 WRITE (10,*) w(1), w(2), uplim1, x(1), x(2), uplim2
		END IF
