...
C      read from/written to the a.out file.
       ...
       OPEN(unit = 88, FILE="sigma_v_2H(a,g)6Li.dat", status = 'old')

       DO i = 1, 60
              read(88, *) T9_arr(i),  sigma_v_2H_a_g_6Li_arr(i)
       END DO

       CLOSE(88)

       OPEN(unit = 89, FILE="sigma_v_12C(p,g)13N.dat", status = 'old')

       DO i = 1, 60
              read(89, *) T9_arr(i),  sigma_v_12C_p_g_13N_arr(i)
       END DO
...
!        i=1                                                                       
!        open(unit=99, FILE="sigma_v_d(p,g)3He.dat", status = 'old')   
!  2     read(99,end=1) T9_arr(i), sigma_v_arr(i)                                            
!        i=i+1   
!        goto 2
