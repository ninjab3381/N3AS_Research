...
!-------throughput variables.
        ...
        integer nsize !size of input arrays
        real x(nsize) !input x values
        real y(nsize) !input y values
...
!-------throughput variables.
        ...
        integer nintpl !size of input arrays
        real xa(nintpl) !input x array
        real ya(nintpl) !input y array
