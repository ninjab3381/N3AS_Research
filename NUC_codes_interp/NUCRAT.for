...
************************************************************* 
*                    Modified by th topel                   *
*                    Monday, July 28, 2003                  *
*              Added comments take the form C///            *
*                'a' denotes line continuation              *
*************************************************************
...
C----------PARAMETER.
      ...
      !real, dimension(60, 2) :: data_temp_rxn



 !     DATA T9_arr /0.001,0.002,0.003,0.004,0.005,0.006,0.007, 0.008,
 !    a            0.009,0.010, 0.011, 0.012,0.013, 0.014, 0.015, 0.016, 
 !    a            0.018, 0.020, 0.025, 0.030, 0.040, 0.050, 0.060,0.070,
 !    a            0.080, 0.090, 0.100, 0.110,0.120, 0.130, 0.140, 0.150, 
 !    a            0.160, 0.180, 0.200, 0.250, 0.300, 0.350, 0.400,0.450, 
 !    a            0.500, 0.600, 0.700, 0.800, 0.900, 1.000, 1.250,1.500, 
 !    a            1.750,2.000, 2.500, 3.000, 3.500, 4.000, 5.000, 6.000, 
 !    a            7.000, 8.000, 9.000, 10.00/
      
C//// The constant 'nrec' denotes the size of the reaction array.
C     If a reaction is added, this must be changed accordingly.      
...
C     Tilley, D.R., Weller, H.R., 
C     and Hasan, H.H., 1987, Nucl. Phys. A474, 1.
...
C----------COMMON AREAS.
       ...
       COMMON /thermo/  thm,hubcst               !Dynamic variables.
       COMMON /nupar/  t9mev,tnmev,tnu,cnorm,nu,rhonu 
...
C///////When of type 'EXTERNAL', error of undefined symbol was given    
C       Made to be of type 'REAL'.

C///////Changed back to EXTERNAL, 8-3-03         
...
C                           !xi(1) is e neutrino degeneracy parameter.
C                           !xi(2) is m neutrino degeneracy parameter.
C                           !xi(3) is t neutrino degeneracy parameter.
...
C----------LOCAL VARIABLES.
       ...
       REAL    w(2),x(2), y(2),z(2)   
       !Upper limits for exponentials, forward (w and x) and reverse (y and z).
       REAL    uplim1,uplim2,uplim3,uplim4        
       !Upper limits for integrals for forward (1 and 2) and reverse (3 and 4 ).
       REAL    part1,part2,part3,part4          
...
C20--------COMPUTE WEAK REACTION RATES (DEGENERATE)------------
         ...
         t9mev = tph*.086171     !Convert photon temp to units of MeV.
         tnmev = tnu*.086171     !Convert neutrino temp to units of MeV.        
C..........COMPUTE OVERFLOW LIMITS FOR 
C          LIMITS OF INTEGRATION (Ref 1 & 2).
...
C----------COMMON AREAS.
       ...
       COMMON /rxn_rate_arr/ T9_arr,sigma_v_d_p_g_3He_arr,
     a sigma_v_val_d_p_g_3He, sigma_v_2H_a_g_6Li_arr, 
     a sigma_v_val_2H_a_g_6Li, sigma_v_12C_p_g_13N_arr, 
     a sigma_v_val_12C_p_g_13N
...
C----------EVOLUTION PARAMETER.
       ...
       real T9_arr(60)
       real sigma_v_d_p_g_3He_arr(60)
       real sigma_v_2H_a_g_6Li_arr(60)
C===========================PROCEDURE DIVISION==============
...
C.......H(n,g)H2...................(Smith-Kawano-Malaney 1992)
     ...
     a                      +8.471e-3*t9*t9-2.80e-4*t9*t932)
...
C.......Be7(n,p)Li7................(Smith-Kawano-Malaney 1992)
     ...
     a        + 2.214e-3*t9*t9-6.851e-5*t9*t932)
     a        + 9.391e+8*t9a32*t9m32
     a        + 4.467e+7*t9m32*ex(-0.07486/t9)

C40--------NEUTRON, ALPHA REACTIONS--------------------------

C.......Li6(n,a)H3.................(Caughlan-Fowler 1988)
       f(18)  = 2.54e+9*t9m32*ex(-2.39/t9)
     a         + 1.68e+8*(1.-.261*t9b32/t932)
...
C.......H3(p,g)He4.................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.108*t913+1.68*t923+1.26*t9+.551*t943+1.06*t953)
...
C.......Li6(p,a)He3................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.050*t913-.061*t923-.021*t9+.006*t943+.005*t953)
     a         + 1.33e+10*t9m32*ex(-17.763/t9)
     a         + 1.29e+09*t9m1*ex(-21.820/t9)

C.......Li7(p,a)He4................(Smith-Kawano-Malaney 1992)
       f(24)  = 1.096e+9*t9m23*ex(-8.472/t913)
     a         - 4.830e+8*t9d56*t9m32*ex(-8.472/t9d13)
     a         + 1.06e+10*t9m32*ex(-30.442/t9)
     a         + 1.56e+5*t9m23*ex((-8.472/t913)-(t9/1.696)**2)
     a           *(1.+.049*t913-2.498*t923+.860*t9+3.518*t943+3.08*t953)
     a         + 1.55e+6*t9m32*ex(-4.478/t9)

C70--------ALPHA, PHOTON REACTIONS------------------------

C.......H2(a,g)Li6.................(Caughlan-Fowler 1988)
       f(25)  = 3.01e+01*t9m23*ex(-7.423/t913)
     a         *(1.+.056*t913-4.85*t923+8.85*t9-.585*t943-.584*t953)
     a         + 8.55e+1*t9m32*ex(-8.228/t9)

       print *, T9_arr(1)

       call interp(60, T9_arr, sigma_v_2H_a_g_6Li_arr, t9, 
     a sigma_v_val_2H_a_g_6Li)
       write(85, *) t9, f(25), sigma_v_val_2H_a_g_6Li

C.......H3(a,g)Li7.................(Smith-Kawano-Malaney 1992)
       f(26)  = 3.032e+5*t9m23*ex(-8.090/t913)
     a         *(1.+.0516*t913+.0229*t923+8.28e-3*t9
     a             -3.28e-4*t943-3.01e-4*t953)
     a         + 5.109e+5*t9e56*t9m32*ex(-8.068/t9e13)

C.......He3(a,g)Be7................(Smith-Kawano-Malaney 1992)
       f(27)  = 4.817e+6*t9m23*ex(-14.964/t913)
     a         *(1.+.0325*t913-1.04e-3*t923-2.37e-4*t9
     a             -8.11e-5*t943-4.69e-5*t953)
     a         + 5.938e+6*t9f56*t9m32*ex(-12.859/t9f13)
...
C.......Be7(p,g)B8.................(Caughlan-Fowler 1988)
     ...
     a         + 2.53e+3*t9m32*ex(-7.306/t9)

C.......Be9(p,g)B10................(Caughlan-Fowler 1988)
       f(41)  = 1.33e+7*t9m23*ex(-10.359/t913-(t9/.846)**2)
     a         *(1.+.040*t913+1.52*t923+.428*t9+2.15*t943+1.54*t953)
     a         + 9.64e+4*t9m32*ex(-3.445/t9)
     a         + 2.72e+6*t9m32*ex(-10.620/t9)

C.......B10(p,g)C11................(Caughlan-Fowler 1988)
       f(42)  = 4.61e+5*t9m23*ex(-12.062/t913-(t9/4.402)**2)
     a         *(1.+.035*t913+.426*t923+.103*t9+.281*t943+.173*t953)
     a         + 1.93e+5*t9m32*ex(-12.041/t9)
     a         + 1.14e+4*t9m32*ex(-16.164/t9)

C.......B11(p,g)C12................(Caughlan-Fowler 1988)
       f(43)  = 4.62e+7*t9m23*ex(-12.095/t913-(t9/.239)**2)
     a         *(1.+.035*t913+3.00*t923+.723*t9+9.91*t943+6.07*t953)
     a         + 7.89e+3*t9m32*ex(-1.733/t9)
     a         + 9.68e+4*t9m15*ex(-5.617/t9)

C.......C11(p,g)N12................(Caughlan-Fowler 1988)
       f(44)  = 4.24e+4*t9m23*ex(-13.658/t913-(t9/1.627)**2)
     a         *(1.+.031*t913+3.11*t923+.665*t9+4.61*t943+2.50*t953)
     a         + 8.84e+3*t9m32*ex(-7.021/t9)
...
C.......Be9(p,a)Li6................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.040*t913+1.09*t923+.307*t9+3.21*t943+2.30*t953)
     a         + 4.51e+8*t9m1*ex(-3.046/t9)
     a         + 6.70e+8*t9m34*ex(-5.160/t9)

C.......B10(p,a)Be7................(Caughlan-Fowler 1988)
       f(47)  = 1.26e+11*t9m23*ex(-12.062/t913-(t9/4.402)**2)
     a         *(1.+.035*t913-.498*t923-.121*t9+.300*t943+.184*t953)
     a         + 2.59e+9*t9m1*ex(-12.260/t9)
...
C.......Li6(a,g)B10................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.022*t913+1.54*t923+.239*t9+2.20*t943+.869*t953)
     a         + 1.91e+3*t9m32*ex(-3.484/t9)
     a         + 1.01e+4*t9m1*ex(-7.269/t9)

C.......Li7(a,g)B11................(Caughlan-Fowler 1988)
       f(50)  = 3.55e+7*t9m23*ex(-19.161/t913-(t9/4.195)**2)
     a         *(1.+.022*t913+.775*t923+.118*t9+.884*t943+.342*t953)
     a         + 3.33e+2*t9m32*ex(-2.977/t9)
     a         + 4.10e+4*t9m1*ex(-6.227/t9)

C.......Be7(a,g)C11................(Caughlan-Fowler 1988)
       f(51)  = 8.45e+7*t9m23*ex(-23.212/t913-(t9/4.769)**2)
     a         *(1.+.018*t913+.488*t923+.061*t9+.296*t943+.095*t953)
     a         + 1.25e+4*t9m32*ex(-6.510/t9)
     a         + 1.29e+5*t9m54*ex(-10.039/t9)
...
C.......Be9(a,n)C12................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.017*t913+8.57*t923+1.05*t9+74.51*t943+23.15*t953)
     a         + 7.34e-5*t9m32*ex(-1.184/t9)
     a         + 2.27e-1*t9m32*ex(-1.834/t9)
     a         + 1.26e+5*t9m32*ex(-4.179/t9)
     a         + 2.40e+8*ex(-12.732/t9)
...
C.......Be9(p,da)He4...............(Caughlan-Fowler 1988)
     ...
     a         *(1.+.040*t913+1.09*t923+.307*t9+3.21*t943+2.30*t953)
     a         + 5.79e+8*t9m1*ex(-3.046/t9)
     a         + 8.50e+8*t9m34*ex(-5.800/t9)

C.......B11(p,2a)He4...............(Caughlan-Fowler 1988)
       f(63)  = 2.20e+12*t9m23*ex(-12.095/t913-(t9/1.644)**2)
     a         *(1.+.034*t913+.140*t923+.034*t9+.190*t943+.116*t953)
     a         + 4.03e+6*t9m32*ex(-1.734/t9)
     a         + 6.73e+9*t9m32*ex(-6.262/t9)
     a         + 3.88e+9*t9m1*ex(-14.154/t9)
...
C----------EVOLUTION PARAMETER.
       ...
       real T9_arr(60)
       real sigma_v_12C_p_g_13N_arr(60)
...
C10--------TEMPERATURE FACTORS-------------------------------------
       ...
       t9b   = t9/(1.+7.76e-2*t9+2.64e-2*t953/(1.+7.76e-2*t9)**(2./3.))
                                    !For reaction 84.     
...
C.......C12(p,g)N13................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.030*t913+1.19*t923+.254*t9+2.06*t943+1.12*t953)
     a         + 1.08e+5*t9m32*ex(-4.925/t9)
     a         + 2.15e+5*t9m32*ex(-18.179/t9)

       print *, T9_arr(1)

       call interp(60, T9_arr, sigma_v_12C_p_g_13N_arr, t9, 
     a sigma_v_val_12C_p_g_13N)
       write(84, *) t9, f(72), sigma_v_val_12C_p_g_13N



C.......C13(p,g)N14................(Caughlan-Fowler 1988)
       f(73)  = 8.01e+7*t9m23*ex(-13.717/t913-(t9/2.000)**2)
     a         *(1.+.030*t913+.958*t923+.204*t9+1.39*t943+.753*t953)
     a         + 1.21e+6*t9m65*ex(-5.701/t9)

C.......C14(p,g)N15................(Caughlan-Fowler 1988)
       f(74)  = 6.80e+6*t9m23*ex(-13.741/t913-(t9/5.721)**2)
     a         *(1.+.030*t913+.503*t923+.107*t9+.213*t943+.115*t953)
     a         + 5.36e+3*t9m32*ex(-3.811/t9)
     a         + 9.82e+4*t9m13*ex(-4.739/t9)

C.......N13(p,g)O14................(Caughlan-Fowler 1988)
       f(75)  = 4.04e+7*t9m23*ex(-15.202/t913-(t9/1.191)**2)
     a         *(1.+.027*t913-.803*t923-.154*t9+5.00*t943+2.44*t953)
     a         + 2.43e+5*t9m32*ex(-6.348/t9)

C.......N14(p,g)O15................(Caughlan-Fowler 1988)
       f(76)  = 4.90e+7*t9m23*ex(-15.228/t913-(t9/3.294)**2)
     a         *(1.+.027*t913-.778*t923-.149*t9+.261*t943+.127*t953)
     a         + 2.37e+3*t9m32*ex(-3.011/t9)
     a         + 2.19e+4*ex(-12.530/t9)

C.......N15(p,g)O16................(Caughlan-Fowler 1988)
       f(77)  = 9.78e+8*t9m23*ex(-15.251/t913-(t9/.450)**2)
     a         *(1.+.027*t913+.219*t923+.042*t9+6.83*t943+3.32*t953)
     a         + 1.11e+4*t9m32*ex(-3.328/t9)
     a         + 1.49e+4*t9m32*ex(-4.665/t9)
     a         + 3.80e+6*t9m32*ex(-11.048/t9)

C60--------PROTON, ALPHA REACTIONS-------------------------------

C.......N15(p,a)C12................(Caughlan-Fowler 1988)
       f(78)  = 1.08e+12*t9m23*ex(-15.251/t913-(t9/.522)**2)
     a         *(1.+.027*t913+2.62*t923+.501*t9+5.36*t943+2.60*t953)
     a         + 1.19e+8*t9m32*ex(-3.676/t9)
     a         + 5.41e+8/t912*ex(-8.926/t9)
     a         + 4.72e+7*t9m32*ex(-7.721/t9)
     a         + 2.20e+8*t9m32*ex(-11.418/t9)
...
C.......C12(a,g)O16................(Caughlan-Fowler 1988)
     ...
     a         /(1.+.0489*t9m23)**2
     a         + 1.76e+8/(t9)**2/(1.+.2654*t9m23)**2*ex(-32.120/t913)
     a         + 1.25e+3*t9m32*ex(-27.499/t9)
     a         + 1.43e-2*(t9)**5*ex(-15.541/t9)
...
C.......B11(a,p)C14................(Caughlan-Fowler 1988)
     ...
     a      *(1.+.015*t913+5.575*t923+.576*t9+15.888*t943+4.174*t953)
     a         + 5.44e-3*t9m32*ex(-2.827/t9)
     a         + 3.36e+2*t9m32*ex(-5.178/t9)
     a         + 5.32e+6/t938*ex(-11.617/t9)
...
C.......B11(a,n)N14................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.015*t913+8.115*t923+.838*t9+39.804*t943
     a             +10.456*t953)
     a         + 1.79e+0*t9m32*ex(-2.827/t9)
     a         + 1.71e+3*t9m32*ex(-5.178/t9)
     a         + 4.49e+6*t935*ex(-8.596/t9)
...
C.......C13(a,n)O16................(Caughlan-Fowler 1988)
     ...
     a         *(1.+.013*t913+2.04*t923+.184*t9)
     a         + 3.82e+5*t9m32*ex(-9.373/t9)
     a         + 1.41e+6*t9m32*ex(-11.873/t9)
     a         + 2.00e+9*t9m32*ex(-20.409/t9)
     a         + 2.92e+9*t9m32*ex(-29.283/t9)
     
     
C//// If a new reaction is added, f(89) must be placed here with a form 
...
C----------COMMON AREAS.
       ...
       COMMON /compr0/ cy0,ct0,t9i0,t9f0,ytmin0,inc0 
...
C                       !c0(2) is default neutron half-life.
C                       !c0(3) is default number of neutrinos.
...
C-----------NUCLIDE DATA.
     ...
     a         12.,12.,13.,13.,14.,14.,14.,15.,15.,16./
       DATA zm /0.,1.,1.,1.,2.,2.,3.,3.,4.,3.,5.,4.,5.,5.,6.,5.,
     a         6.,7.,6.,7.,6.,7.,8.,7.,8.,8./
       DATA dm /.008665,.007825,.014102,.016050,.016030,.002603,.015125,
     a         .016004,.016929,.022487,.024609,.012186,.012939,.009305,
     a         .011432,.014354,.000000,.018641,.003354,.005738,.003242,
     a         .003074,.008597,.000108,.003070,-.005085/

C----------REACTION RATE COEFFICIENTS (Ref 1).
       DATA ((reacpr(i,j),j=1,8),i=1,11) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a             1.,1., 1.,0.,0., 2., 0.0  ,   0.0 ,     !N->P
     a             2.,1., 4.,0.,0., 5., 0.0  ,   0.0 ,     !H3->He3
     a             3.,4.,10.,0.,0., 6., 0.0  ,   0.0 ,     !Li8->2He4
     a             4.,1.,16.,0.,0.,17., 0.0  ,   0.0 ,     !B12->C12
     a             5.,1.,21.,0.,0.,22., 0.0  ,   0.0 ,     !C14->N14
     a             6.,4.,11.,0.,0., 6., 0.0  ,   0.0 ,     !B8->2He4
     a             7.,1.,15.,0.,0.,14., 0.0  ,   0.0 ,     !C11->B11
     a             8.,1.,18.,0.,0.,17., 0.0  ,   0.0 ,     !N12->C12
     a             9.,1.,20.,0.,0.,19., 0.0  ,   0.0 ,     !N13->C13
     a            10.,1.,23.,0.,0.,22., 0.0  ,   0.0 ,     !O14->N14
     a            11.,1.,25.,0.,0.,24., 0.0  ,   0.0 /     !O15->N15
       DATA ((reacpr(i,j),j=1,8),i=12,22) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            12.,2., 2.,1.,0., 3., 0.471,  25.82,     !H(n,g)H2
     a            13.,2., 3.,1.,0., 4., 1.63 ,  72.62,     !H2(n,g)H3
     a            14.,2., 5.,1.,0., 6., 2.61 , 238.81,     !He3(n,g)He4         
     a            15.,2., 7.,1.,0., 8., 1.19 ,  84.17,     !Li6(n,g)Li7
     a            16.,3., 5.,1.,2., 4., 1.002,   8.863,    !He3(n,p)H3
     a            17.,3., 9.,1.,2., 8., 0.998,  19.081,    !Be7(n,p)Li7
     a            18.,3., 7.,1.,4., 6., 1.070,  55.494,    !Li6(n,a)H3
     a            19.,5., 9.,1.,0., 6., 4.70 , 220.39,     !Be7(n,a)He4
     a            20.,2., 3.,2.,0., 5., 1.63 ,  63.750,    !H2(p,g)He3
     a            21.,2., 4.,2.,0., 6., 2.61 , 229.932,    !H3(p,g)He4
     a            22.,2., 7.,2.,0., 9., 1.19 ,  65.054/    !Li6(p,g)Be7
       DATA ((reacpr(i,j),j=1,8),i=23,33) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            23.,3., 7.,2.,5., 6., 1.07 ,  46.631,    !Li6(p,a)He3
     a            24.,5., 8.,2.,0., 6., 4.69 , 201.291,    !Li7(p,a)He4
     a            25.,2., 6.,3.,0., 7., 1.53 ,  17.118,    !H2(a,p)Li6
     a            26.,2., 6.,4.,0., 8., 1.11 ,  28.640,    !H3(a,p)Li7
     a            27.,2., 6.,5.,0., 9., 1.11 ,  18.423,    !He3(a,p)Be7
     a            28.,6., 3.,0.,1., 5., 1.73 ,  37.935,    !H2(d,p)He3
     a            29.,6., 3.,0.,2., 4., 1.73 ,  46.798,    !H2(d,n)H3
     a            30.,3., 4.,3.,1., 6., 5.54 , 204.117,    !H3(d,n)He4
     a            31.,3., 5.,3.,2., 6., 5.55 , 212.980,    !He3(d,p)He4
     a            32.,11.,5.,0.,2., 6., 3.39 , 149.230,    
                  !He3(He3,2p)He4      
     a            33.,9., 8.,3.,1., 6., 9.95 , 175.476/    !Li7(d,na)He4
       DATA ((reacpr(i,j),j=1,8),i=34,44) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            34.,9., 9.,3.,2., 6., 9.97 , 194.557,    
                   !Be7(d,pa)He4       
     a            35.,2., 8.,1.,0.,10., 1.31 ,  23.59,     !Li7(n,g)Li8        
     a            36.,2.,13.,1.,0.,14., 3.04 , 132.95,     !B10(n,g)B11
     a            37.,2.,14.,1.,0.,16., 2.34 ,  39.10,     !B11(n,g)B12
     a            38.,3.,15.,1.,2.,14., 1.002,  32.080,    !C11(n,p)B11
     a            39.,3.,13.,1.,6., 8., 0.758,  32.382,    !B10(n,a)Li7
     a            40.,2., 9.,2.,0.,11., 1.30 ,   1.595,    !Be7(p,g)B8
     a            41.,2.,12.,2.,0.,13., 0.973,  76.427,    !Be9(p,g)B10
     a            42.,2.,13.,2.,0.,15., 3.03 , 100.840,    !B10(p,g)C11
     a            43.,2.,14.,2.,0.,17., 7.01 , 185.173,    !B11(p,g)C12
     a            44.,2.,15.,2.,0.,18., 2.33 ,   6.975/    !C11(p,g)N12
       DATA ((reacpr(i,j),j=1,8),i=45,55) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            45.,3.,16.,2.,1.,17., 3.00 , 146.08,     !B12(p,n)C12        
     a            46.,3.,12.,2.,6., 7., 0.618,  24.674,    !Be9(p,a)Li6
     a            47.,3.,13.,2.,6., 9., 0.754,  13.301,    !B10(p,a)Be7
     a            48.,3.,16.,2.,6.,12., 0.292,  79.89,     !B12(p,a)Be9
     a            49.,2., 7.,6.,0.,13., 1.58 ,  51.753,    !Li6(a,g)B10
     a            50.,2., 8.,6.,0.,14., 4.02 , 100.538,    !Li7(a,g)B11
     a            51.,2., 9.,6.,0.,15., 4.02 ,  87.539,    !Be7(a,g)C11
     a            52.,3.,11.,6.,2.,15., 3.08 ,  86.00,     !B8(a,p)C11
     a            53.,3.,10.,6.,1.,14., 3.07 ,  76.96,     !Li8(a,n)B11
     a            54.,3.,12.,6.,1.,17.,10.3  ,  66.160,    !Be9(a,n)C12
     a            55.,3.,12.,3.,1.,13., 2.07 ,  50.63/     !Be9(d,n)B10
       DATA ((reacpr(i,j),j=1,8),i=56,66) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            56.,3.,13.,3.,2.,14., 6.44 , 107.13,   !B10(d,p)B11
     a            57.,3.,14.,3.,1.,17.,14.9  , 159.36,   !B11(d,n)C12
     a            58.,8., 6.,1.,0.,12., 0.584,  18.260,  !He4(an,g)Be9       
     a            59.,7., 6.,0.,0.,17., 2.00 ,  84.420,  !He4(2a,g)C12
     a            60.,9.,10.,2.,1., 6., 3.58 , 177.73,   !Li8(p,na)He4
     a            61.,9.,11.,1.,2., 6., 3.58 , 218.82,   !B8(n,pa)He4
     a            62.,9.,12.,2.,3., 6., 0.807,   7.555,  !Be9(p,da)He4
     a            63.,10.,14.,2.,0.,6., 3.50 , 100.753,  !B11(p,2a)Be4
     a            64.,10.,15.,1.,0.,6., 3.49 , 132.83,   !C11(n,2a)He4
     a            65.,2.,17.,1.,0.,19., 0.886,  57.41,   !C12(n,g)C13
     a            66.,2.,19.,1.,0.,21., 3.58 ,  94.88/   !C13(n,g)C14
       DATA ((reacpr(i,j),j=1,8),i=67,77) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            67.,2.,22.,1.,0.,24., 2.71 , 125.74,  !N14(n,g)N15
     a            68.,3.,20.,1.,2.,19., 1.002,  34.846, !N13(n,p)C13
     a            69.,3.,22.,1.,2.,21., 3.003,   7.263, !N14(n,p)C14
     a            70.,3.,25.,1.,2.,24., 1.002,  41.037, !O15(n,p)N15
     a            71.,3.,25.,1.,6.,17., 0.709,  98.661, !O15(n,a)C12
     a           72.,2.,17.,2.,0.,20., 0.884,  22.553,  !C12(p,g)N13
     a            73.,2.,19.,2.,0.,22., 1.19 ,  87.621, !C13(p,g)N14
     a           74.,2.,21.,2.,0.,24., 0.900, 118.452,  !C14(p,g)N15
     a            75.,2.,20.,2.,0.,23., 3.57 ,  53.706, !N13(p,g)O14
     a            76.,2.,22.,2.,0.,25., 2.70 ,  84.678, !N14(p,g)O15
     a            77.,2.,24.,2.,0.,26., 3.62 , 140.734/ !N15(p,g)O16
       DATA ((reacpr(i,j),j=1,8),i=78,88) /
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     a            78.,3.,24.,2.,6.,17., 0.706,  57.623, !N15(p,a)C12
     a            79.,2.,17.,6.,0.,26., 5.13 ,  83.111, !C12(a,g)O16
     a            80.,3.,13.,6.,2.,19., 9.36 ,  47.16,  !B10(a,p)C13
     a            81.,3.,14.,6.,2.,21.,11.0  ,   9.098, !B11(a,p)C14
     a            82.,3.,15.,6.,2.,22., 3.68 ,  33.915, !C11(a,p)N14
     a            83.,3.,18.,6.,2.,25., 4.26 , 111.87,  !N12(a,p)O15
     a            84.,3.,20.,6.,2.,26., 5.81 ,  60.557, !N13(a,p)O16
     a            85.,3.,13.,6.,1.,20., 9.34 ,  12.287, !B10(a,n)N13
     a            86.,3.,14.,6.,1.,22., 3.67 ,   1.835, !B11(a,n)N14
     a            87.,3.,16.,6.,1.,24., 4.25 ,  88.47,  !B12(a,n)N15
     a            88.,3.,19.,6.,1.,26., 5.79 ,  25.711/ !C13(a,n)O16
C/// a            89.,6.,3. ,0.,1.,5. , 1.70 ,  37.930/ !NEW REACTION
     
C///// If a new reaction is added (beyond the default 88 reactions),
C      nrec must be changed to the new value, the ending value of the 
C      above DATA statement must be changed, and a new line must be 
C      added to the above block.     

C----------DEFAULT COMPUTATION PARAMETERS.
       DATA cy0    /.0300/              !Default time step limiting constant.
       DATA ct0    /.0030/              !Default time step limiting constant.
       ...
       DATA inc0   /150/                !Default accumulation increment.

C-----------DEFAULT MODEL PARAMETERS.
       DATA c0     /1.00,885.7,3.0/   !Default variation of 3 parameters.
       DATA cosmo0 /0.00/              !Default cosmological constant.
       DATA xi0    /0.00,0.00,0.0/     !Default neutrino degeneracy parameter.
